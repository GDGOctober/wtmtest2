    ...
    <div class="bgcolor">
        <main class="container wow fadeIn " data-wow-duration="1.5s">
            <div class="row">
                ...
                <div class="aboutus">
                    <p class="lead">
                        Women Techmakers Is Google's Global Program And Brand For Women In Technology. Kicked Off In <span class="highmark">2012</span> By Then VP Of Google <a href="https://twitter.com/smithmegan" target="_blank" draggable="false">Megan Smith</a>, Women Techmakers Is Now Led By Women In Technology Advocate Natalie Villalobos And A Global Team Of Googlers Who Are Passionate About Empowering Women In Technology Through Increased Visibility, Community, and Resources.
                        <br>
                        <span class="highmark">Mission: Support and empower women in the industry.</span>
                    </p>
                </div>
            </div>
        </main>
                ...
                <div class="row wow fadeIn ">
                    <div class="event-info col-xs-12">
                        <div class="title wow fadeIn " data-wow-duration="1.5s">
                            <a href="http://devfest.gdgoctober.org" target="_blank" draggable="false"><h1>GDG 6th October DevFest'17</h1></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="devfestTime row wow fadeIn ">
                    <div class="col-xs-12 text-center address wow fadeIn " data-wow-delay="0.5s">
                        <span class="place wow fadeIn " data-wow-delay="0.5s">
                            <a href="https://goo.gl/maps/rdCQUBHN4p92" target="_blank" draggable="false"><span class="glyphicon glyphicon-map-marker wow bounce " data-wow-duration="1.5s" data-wow-iteration="1"></span>
...
<section id="iwd17" class="wow fadeIn ">
    <div class="container">
        <div class="row wow fadeIn " data-wow-duration="1.5s">
            <div class="iwd17IMGBox col-xs-12 col-md-8">
                <picture>
                    ...
                    <img src="imgs/iwd17/InternationalWomensDay-landscape.png" alt="IWD17" title="INTERNATIONAL WOMEN’S DAY (IWD)" class="img-responsive" draggable="false">
                </picture>
            </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                <p class="lead title general wow fadeIn " data-wow-duration="1.5s">The Women Techmaker Global Event Series Celebrating International Women’s Day.</p>

                <p class="article lead wow fadeInLeft " data-wow-duration="1.5s">
                    <span class="q">What is International Women’s Day ?</span>
                    <br>
                    <a href="https://www.internationalwomensday.com" target="_blank" draggable="false">International Women's Day (IWD)</a> is marked on March 8th every year. In different regions, the focus of celebrations ranges from general respect and appreciation toward women to a celebration of women's economic, political, and social achievements.
                </p>

                <p class="article lead wow fadeInRight " data-wow-duration="1.5s">
                    <span class="q">Why does Google Celebrate IWD ?</span>
                    <br>
                    From Ada Lovelace to Grace Hopper to thousands of Googlers, we're proud of the contributions women in technology have made across our industry and across our company. And we're excited by the contributions women continue to make today. Google supports and celebrates women in technology through numerous initiatives including Small Business Supplier Diversity and Accelerate with Google programs, the Google Cultural Institute, our Women@ employee resource group and more. International Women's Day is an important moment to recognize how women have influenced the tech industry and beyond.
                </p>
            </div>
        </div>
...
<section id="membership" class="wow fadeIn ">
    <div class="container">
        ...
        <div class="row wow fadeIn " data-wow-duration="1.5s">
            <div class="col-xs-12">
                <p class="lead article">Membership empowers women in their careers by providing access to curated resources and events, as well as information and tools from Google, our partners, and the global tech ecosystem. 
                </p>
            </div>
        </div>
